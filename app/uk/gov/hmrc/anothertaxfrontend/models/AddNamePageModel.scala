...
object AddNamePageModel {
  ...
  implicit val reads: Reads[AddNamePageModel] = Json.reads[AddNamePageModel]

  val form: Form[AddNamePageModel] = Form(
    mapping(
      "firstName" -> text
      ...
      "lastName" -> text
        ...
        .verifying("Last name cannot contain numbers or special characters", value => value.forall(_.isLetter))
      ,
    )(AddNamePageModel.apply)(AddNamePageModel.unapply)
  )
}
